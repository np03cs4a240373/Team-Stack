...
<div class="dashboard-body">
    ...
    <!-- Shows 6 number cards in 2 rows of 3 -->
                    ...
                    <tbody>
                        <?php foreach ($recentUsers as $user): ?>
                            <tr>
                                ...
                                <!-- Show user role :blue=admin, green=employer, yellow=seeker -->
                                <td>
                                ...
                                <!-- Show delete button for all users except currently logged-in admin -->
                                <td>
                    ...
                    <tbody>
                        <?php foreach ($recentJobs as $job): ?>
                            <tr>
                                ...
                                <!-- Job status such as  active, closed, etc-->
                                <td>
